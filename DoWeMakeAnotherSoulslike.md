...
<br> After cleaning and merging the dataframes, we’ll now process the
data further in order to make a chart to visualize the information we
want to see. We’ll do this by first grouping the data by genres and
calculating the average rating. <br> <br>
